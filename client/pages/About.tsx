        ...
        <div className="container mx-auto px-4 md:px-16">
          <div className="flex flex-col items-center justify-center gap-14">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 w-full max-w-5xl">
              {/* Card 1: Figma */}
              <div className="flex flex-col items-center gap-6 p-6 w-full md:w-44 h-72 border border-gray-200 rounded-lg bg-gray-50 shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-up" style={{ animationDelay: "0s" }}>
                ...
                <div className="flex flex-col gap-4 items-center w-full justify-between flex-1">
              ...
              {/* Card 2: Fusion */}
              <div className="flex flex-col items-center gap-6 p-6 w-full md:w-44 h-72 border border-gray-200 rounded-lg bg-gray-50 shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-up" style={{ animationDelay: "0.1s" }}>
              ...
              {/* Card 3: Builder */}
              <div className="flex flex-col items-center gap-6 p-6 w-full md:w-44 h-72 border border-gray-200 rounded-lg bg-gray-50 shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-up" style={{ animationDelay: "0.2s" }}>
              ...
              {/* Card 4: Next.js */}
              <div className="flex flex-col items-center gap-6 p-6 w-full md:w-44 h-72 border border-gray-200 rounded-lg bg-gray-50 shadow-md transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-up" style={{ animationDelay: "0.3s" }}>
