        ...
        <div className="container mx-auto px-4 md:px-16">
          <div className="flex flex-col items-center justify-center gap-14">
            ...
            <div className="flex flex-col md:flex-row items-stretch justify-center gap-3 w-full">
              {/* Card 1: Figma */}
              <div className="flex flex-col items-center gap-6 py-[22px] px-2 flex-1 rounded-lg border border-[#E5E7EB] bg-[#FAFAFA] transition-all duration-300 hover:shadow-lg hover:scale-105 animate-slide-up"
                   style={{
                     animationDelay: "0s",
              ...
              {/* Arrow 1 */}
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg" className="hidden md:block flex-shrink-0 self-center">
        ...
        <div className="container mx-auto px-4 md:px-16">
          <div className="flex flex-col items-center justify-center gap-14">
            ...
            <div className="flex flex-col items-start gap-3 w-full">
              ...
              <p className="text-lg leading-7 text-center w-full" style={{ color: "rgba(44, 44, 44, 0.6)" }}>
              ...
              <div className="flex">
                <div className="flex animate-ticker">
                  ...
                  <div className="flex gap-3 px-1.5">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 py-[22px] px-2 min-w-[140px] rounded-lg">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M18 27.4002C19.8667 19.9335 24.5333 16.2002 32 16.2002C43.2 16.2002 44.6 24.6002 50.2 26.0002C53.9333 26.9335 57.2 25.5335 60 21.8002C58.1333 29.2669 53.4667 33.0002 46 33.0002C34.8 33.0002 33.4 24.6002 27.8 23.2002C24.0667 22.2669 20.8 23.6669 18 27.4002ZM4 44.2002C5.86667 36.7335 10.5333 33.0002 18 33.0002C29.2 33.0002 30.6 41.4002 36.2 42.8002C39.9333 43.7335 43.2 42.3335 46 38.6002C44.1333 46.0669 39.4667 49.8002 32 49.8002C20.8 49.8002 19.4 41.4002 13.8 40.0002C10.0667 39.0669 6.8 40.4669 4 44.2002Z" fill="#44A8B3"/>
                      </svg>
                      <h3 className="text-base font-semibold text-text-tertiary text-center leading-[22px] tracking-[-0.18px]">
                        Tailwind
                      </h3>
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 py-[22px] px-2 min-w-[140px] rounded-lg">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_100_399)">
                          <path d="M33.4788 0.412323C33.0195 0.149183 32.4994 0.0107422 31.97 0.0107422C31.4407 0.0107422 30.9206 0.149183 30.4613 0.412323L5.55129 14.8798C4.60379 15.4158 4.07129 16.4273 4.07129 17.4998V46.4938C4.07129 47.5653 4.66279 48.5773 5.55029 49.1138L30.4603 63.5808C30.9196 63.8441 31.4399 63.9825 31.9693 63.9825C32.4987 63.9825 33.0189 63.8441 33.4783 63.5808L58.3883 49.1133C59.3353 48.5773 59.8673 47.5653 59.8673 46.4933V17.4998C59.8673 16.4278 59.2758 15.4163 58.3883 14.8798L33.4788 0.412323Z" fill="url(#paint0_linear_100_399)"/>
                          <path d="M58.4485 14.8802L33.4205 0.412734C33.1749 0.28731 32.9171 0.187613 32.651 0.115234L4.60498 48.3992C4.83731 48.6841 5.11771 48.9261 5.43348 49.1142L30.462 63.5812C31.172 63.9977 32 64.1172 32.7695 63.8787L59.0995 15.4162C58.9266 15.1898 58.7039 15.0064 58.4485 14.8802Z" fill="url(#paint1_linear_100_399)"/>
                          <path d="M58.4488 49.1126C59.1588 48.6961 59.6913 47.9816 59.9278 47.2076L32.5328 0.0541294C31.8228 -0.0648706 31.0533 -0.00537062 30.4028 0.411629L5.55176 14.8196L32.3548 63.9971C32.7098 63.9371 33.1248 63.8181 33.4798 63.6396L58.4488 49.1126Z" fill="url(#paint2_linear_100_399)"/>
                        </g>
                        <defs>
                          <linearGradient id="paint0_linear_100_399" x1="42.1142" y1="11.1861" x2="19.3649" y2="57.3063" gradientUnits="userSpaceOnUse">
                          ...
                          <linearGradient id="paint1_linear_100_399" x1="28.1853" y1="35.3831" x2="91.6581" y2="-11.2257" gradientUnits="userSpaceOnUse">
                          ...
                          <linearGradient id="paint2_linear_100_399" x1="3.1596" y1="31.9873" x2="60.7998" y2="31.9873" gradientUnits="userSpaceOnUse">
                    ...
                    <div className="flex flex-col items-center justify-center gap-4 py-[22px] px-2 min-w-[140px] rounded-lg">
                      <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clipPath="url(#clip0_100_399_2)">
                          <path d="M33.4788 0.412323C33.0195 0.149183 32.4994 0.0107422 31.97 0.0107422C31.4407 0.0107422 30.9206 0.149183 30.4613 0.412323L5.55129 14.8798C4.60379 15.4158 4.07129 16.4273 4.07129 17.4998V46.4938C4.07129 47.5653 4.66279 48.5773 5.55029 49.1138L30.4603 63.5808C30.9196 63.8441 31.4399 63.9825 31.9693 63.9825C32.4987 63.9825 33.0189 63.8441 33.4783 63.5808L58.3883 49.1133C59.3353 48.5773 59.8673 47.5653 59.8673 46.4933V17.4998C59.8673 16.4278 59.2758 15.4163 58.3883 14.8798L33.4788 0.412323Z" fill="url(#paint0_linear_100_399_2)"/>
                          <path d="M58.4485 14.8802L33.4205 0.412734C33.1749 0.28731 32.9171 0.187613 32.651 0.115234L4.60498 48.3992C4.83731 48.6841 5.11771 48.9261 5.43348 49.1142L30.462 63.5812C31.172 63.9977 32 64.1172 32.7695 63.8787L59.0995 15.4162C58.9266 15.1898 58.7039 15.0064 58.4485 14.8802Z" fill="url(#paint1_linear_100_399_2)"/>
                          <path d="M58.4488 49.1126C59.1588 48.6961 59.6913 47.9816 59.9278 47.2076L32.5328 0.0541294C31.8228 -0.0648706 31.0533 -0.00537062 30.4028 0.411629L5.55176 14.8196L32.3548 63.9971C32.7098 63.9371 33.1248 63.8181 33.4798 63.6396L58.4488 49.1126Z" fill="url(#paint2_linear_100_399_2)"/>
                        </g>
                        <defs>
                          <linearGradient id="paint0_linear_100_399_2" x1="42.1142" y1="11.1861" x2="19.3649" y2="57.3063" gradientUnits="userSpaceOnUse">
                            <stop stopColor="#3F873F"/>
                            <stop offset="0.33" stopColor="#3F8B3D"/>
                            <stop offset="0.637" stopColor="#3E9638"/>
                            <stop offset="0.934" stopColor="#3DA92E"/>
                          ...
                          <linearGradient id="paint1_linear_100_399_2" x1="28.1853" y1="35.3831" x2="91.6581" y2="-11.2257" gradientUnits="userSpaceOnUse">
                            <stop offset="0.138" stopColor="#3F873F"/>
                            <stop offset="0.402" stopColor="#52A044"/>
                            <stop offset="0.713" stopColor="#64B749"/>
                            <stop offset="0.908" stopColor="#6ABF4B"/>
                          </linearGradient>
                          <linearGradient id="paint2_linear_100_399_2" x1="3.1596" y1="31.9873" x2="60.7998" y2="31.9873" gradientUnits="userSpaceOnUse">
                            <stop offset="0.092" stopColor="#6ABF4B"/>
                            <stop offset="0.287" stopColor="#64B749"/>
                            <stop offset="0.598" stopColor="#52A044"/>
                            <stop offset="0.862" stopColor="#3F873F"/>
