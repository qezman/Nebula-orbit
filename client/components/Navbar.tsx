...
export default function Navbar() {
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-zinc-200/50">
      <div className="w-full max-w-[1200px] mx-auto px-4 py-2.5">
        <div className="flex items-center justify-center gap-8 lg:gap-[135px] h-[70px]">
          {/* Logo */}
          <div className="flex items-center justify-center px-2.5">
            <Link
              to="/"
              className="flex items-center justify-center gap-2.5 px-0 py-1.5 rounded bg-zinc-200"
            >
              ...
              <span className="text-zinc-700 text-xl font-medium">
                Nebula
              </span>
            </Link>
          </div>
          ...
          {/* Navigation Links */}
          <div className="hidden md:flex items-center justify-center gap-5 px-2.5">
            <Link
              to="/"
              className="flex items-center justify-center gap-2.5 rounded bg-zinc-200 px-3 py-1.5 text-zinc-700 text-xl font-medium hover:bg-zinc-300 transition-colors"
            >
              Features
            </Link>
            <Link
            ...
            <a
              href="#pricing"
              className="flex items-center justify-center gap-2.5 rounded bg-zinc-200 px-3 py-1.5 text-zinc-700 text-xl font-medium hover:bg-zinc-300 transition-colors opacity-50 cursor-not-allowed"
              title="Coming Soon"
            >
              Pricing
            </a>
          ...
          {/* CTAs */}
          <div className="hidden sm:flex items-center justify-center gap-5 px-2.5 flex-1">
            <Link
              to="/generator"
              className="flex items-center justify-center gap-2.5 px-0 py-1.5 rounded bg-zinc-200 text-zinc-700 text-xl font-medium hover:bg-zinc-300 transition-colors"
            >
              Get Started
            </Link>
            <button className="flex items-center justify-center gap-2.5 px-6 py-1.5 rounded bg-indigo-500 hover:bg-indigo-600 transition-colors text-white text-xl font-medium">
              Sign In
            </button>
          </div>

          {/* Mobile Menu Button */}
          <button className="md:hidden ml-auto p-2 text-zinc-700 hover:text-indigo-500">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
